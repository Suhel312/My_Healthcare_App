...
public class AppBookAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_book_appointment);
...
//        timepicker
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AppBookAppointment.this,AppFindDoctor.class));
            }
        });
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(db.checkAppointmentExists(username, title+" => "+fullname, address, contact, dateButton.getText().toString(),timeButton.getText().toString())==1){
                    ...
                    db.addOrder (username,title+" => "+fullname,address,0,contact,dateButton.getText().toString(),timeButton.getText().toString(),Float.parseFloat(fees),"appointment");
                    Toast.makeText(getApplicationContext(),"Your appointmnet is done successfully", Toast.LENGTH_LONG).show();
                    startActivity (new Intent(AppBookAppointment. this, AppHome.class));
                }
            }
        });
    }
