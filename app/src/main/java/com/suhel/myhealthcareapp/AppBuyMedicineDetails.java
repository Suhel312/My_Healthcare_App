...
public class AppBuyMedicineDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_buy_medicine_details);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AppBuyMedicineDetails.this,AppBuyMedicine.class));
            }
        });
